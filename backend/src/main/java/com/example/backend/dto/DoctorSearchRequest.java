...
public record DoctorSearchRequest(
    ...
    @Min(value = 0, message = "maxExperience must be >= 0")
    Integer maxExperience,
    @DecimalMin(value = "0.0", inclusive = true, message = "minFee must be >= 0")
    BigDecimal minFee, 
    @DecimalMin(value = "0.0", inclusive = true, message = "maxFee must be >= 0")
    BigDecimal maxFee, 
    ...
    @Pattern(regexp = "(?i)id|experienceYears|consultationFee|title", message = "sortBy is invalid")
    String sortBy,
