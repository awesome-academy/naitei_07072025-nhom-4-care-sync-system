...
public record PaymentRequest(
        ...
        @Schema(description = "Return URL after payment", example = "https://app.healthbooking.com/payment/success")
        @ValidUrl(message = "Return URL must be a valid HTTP/HTTPS URL with proper domain and format")
        String returnUrl
) {} 
